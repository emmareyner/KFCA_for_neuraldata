function [Rsquared,adjRsquared,rmserr,beta,stats] = multreg(x,y,verbose,dopic);

% MULTREG multiple regression
% 
%    [Rsquared,adjRsquared,rmserr,beta,stats] = mlr(x,y,[verbose,dopic]);
%
...
%    rmserr is rms error using ANOVA. 
%
...
adjRsquared = 1 - (1-Rsquared)*((n-1)/(n-p));
r2 = Rsquared*100;
adjr2 = adjRsquared*100;
