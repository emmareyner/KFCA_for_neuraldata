...
%
% Adapted from 
% http://www.mathworks.com/matlabcentral/fileexchange/33068-a-multidimensional-map-class/content/memoize.m
% by David Young 2011


persistent store%through different invocations!

%store = MapN;
%store = sparse(1,1,0);% 1 -> 0
