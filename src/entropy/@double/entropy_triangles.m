function [h,H_Pxy, H_Px,H_Py, MI_Pxy]=entropy_triangles(Pxy,varargin)
% function [h,H_Pxy, H_Px,H_Py, MI_Pxy]=entropy_triangles(Pxy,varargin)
%
% A function to represent, side by side the split and non-split versions of
% the triangle.
...
h=[h1 h2 h3];
return%[h,H_Pxy, H_Px,H_Py, MI_Pxy]
