function [matrices]=generate_matrices4(N,n,k,spur)
...
for g=1:n
    ...
    for i=1:multm
        ...
        for j=1:nfactors
            thesePx= [thesePx ones(1,mult(i,factors(j)))*factors(j)];
        end
        Pxg(1:length(thesePx),i) = thesePx;
    end
    Px=[Px Pxg];
end
