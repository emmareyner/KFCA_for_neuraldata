function [Kout]=confMatrix_analysis(datadir,labelsdir, matfilename, elabelsfilename, rlabelsfilename, outdirbase, maxplus, ignoreperfect, mask, description);
...
pmi_mat_sin_inf(isinf(I))=0;%better to use logical indexing
...
if ignoreperfect
    ...
    Kout = explore_in_phiv2_bow(K,outdirbase,inv);
end
