...
% pointwise mutual information operator [PI,Pxy,MI,Hxy,WPI] = pmi(N)
%
% From a count matrix, N, describing the occurrence of joint events of two
% different phenomena, this obtains the pointwise mutual information (PI) in bits of
...
% 
% The weighted pointwise mutual information (WPI) can be easily calculated
...
if nargout > 2%Calculate also MI
    nulls = sparse(Pxy == 0);
    WPI = Pxy.*PI;%Weighed pointwise mutual info
