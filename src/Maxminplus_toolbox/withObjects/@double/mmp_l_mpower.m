function [Y]=mmp_l_mpower(X,n)
% mmp_l_mpower maxminplus lower algebraic power of matrix or scalar   
%
% mmp_l_mpower(X,n) = X^n.
%
...
elseif (mn ~= nn)
    ...
    error('Double:mmp_l_mpower','exponent must be an integer scalar');
end
return% Y
%% Parameter validation
% %error(nargchk(2,2,nargin));
