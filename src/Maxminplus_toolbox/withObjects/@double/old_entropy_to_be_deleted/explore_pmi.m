function [Ixy, Pxy, MI, Hxy,Hxymax, h] = explore_pmi(rawcounts,varargin)
% function [Ixy, Pxy, MI, Hxy,Hxymax,h] =explore_pmi(rawcounts,h,rows,row,optionlist)
% function [Ixy, Pxy, MI, Hxy,Hxymax,h] =explore_pmi(rawcounts,optionlist)
%
