classdef VizgraphNode < dynamicprops & hgsetget
...
% http://www.cs.ubc.ca/~mdunham/
    ...
    methods
        ...
        function obj = VizgraphNode(label)
         % Node Constructor
            obj.label = label;
...
% '-cellMode'   if true, a cell array of strings is returned, instead of a char array.
    ...
    [S,minSize,maxSize,cellMode,center] = my.processArgs(varargin,'*+-S','','-minSize',8,'-maxSize',10,'-cellMode',false,'-center',true);
