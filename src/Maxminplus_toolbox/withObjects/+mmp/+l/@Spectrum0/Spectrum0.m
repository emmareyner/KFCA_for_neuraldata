...
%         comps = {};%components
        ...
        %global indexes for 
        nodes = 0;%Number of nodes in the matrix.
...
%         [Levt,Ldiag,Rev,enodes,nodes]=basis(SSpp)
        ...
        [Ut,Ldiag,V,lcnodes,rcnodes]=UtSV(S,allevs)
    end
    methods (Static)
        % A) ANALYSIS METHODS
%         %
